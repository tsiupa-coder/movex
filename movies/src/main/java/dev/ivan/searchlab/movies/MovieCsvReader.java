...
public final class MovieCsvReader {
    public interface RowConsumer {
        void accept(Movie m) throws Exception;
    }
    ...
    private static Integer intNum(String s) {
        try {
    ...
    private static Long longNum(String s) {
        try {
    ...
    private static Double doubleNum(String s) {
        try {
